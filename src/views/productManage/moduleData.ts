...
export function getProdCodeColumns(): BasicColumn[] {
  return [
    ...
    { dataIndex: 'prodName', title: '商品名称', key: 'prodName', ellipsis: false },
    ...
    { dataIndex: 'speName', title: '规格', key: 'speName', ellipsis: false },
...
export function getProdStyleColumns(): BasicColumn[] {
  return [
    ...
    { dataIndex: 'styleName', title: '款名', key: 'styleName', ellipsis: false },
...
export function getMaterialColumns(): BasicColumn[] {
  return [
    ...
    { dataIndex: 'matName', title: '名称', key: 'matName', ellipsis: false },
    { dataIndex: 'comName', title: '品牌', key: 'comName', defaultHidden: true },
